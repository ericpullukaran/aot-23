...
type FindSantaInArray<T extends Array<string>> = {
  [I in keyof T as number]: T[I] extends "🎅🏼"
    ? ExtractNumber<I & string>
    : never;
}[number];

type FindSanta<T extends Array<Array<string>>> = {
  [I in keyof T]: FindSantaInArray<T[I]> extends never
    ? never
    : [ExtractNumber<I & string>, FindSantaInArray<T[I]>];
}[number];
